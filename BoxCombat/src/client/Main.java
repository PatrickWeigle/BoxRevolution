...
public class Main extends StateBasedGame {
    ...
    //------------------------------------------------------------------- Config
    public static final String gamename = "BoxCombat";
    ...
    public Main(String gamename) {
        super(gamename);
        this.addState(new Principal(game)); // adiciona o estado game, o único do jogo. Preparando uso da classe Principal, a principal do jogo.      
